...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    var tiles = Tiles()
    var x = CrosswordsGenerator(columns: 13, rows: 13, words: ["ASIF", "CAIRO", "CHOO", "LEIF", "ALTER", "TINE", "ERMA", "MAH", "THINS", "KNOCK", "PLEA", "AVE", "EIN", "OTS", "SLY", "ZAC", "FOP", "FIR", "IOS", "TETE", "LETAT", "ASKME", "DOM", "LOAN", "MINI", "GODNO", "SULU", "ADOS", "GREEN", "GETS",
